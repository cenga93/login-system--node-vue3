          ...
          <div class="mx-auto max-w-7xl">
               <nav class="relative z-50 h-24 select-none">
                    ...
                    >
                         ...
                         <div
                              class="top-0 fixed left-0 items-start w-full h-full p-4 text-sm bg-gray-900 bg-opacity-50 md:items-center md:w-3/4 md:absolute lg:text-base md:bg-transparent md:p-0 md:relative md:flex"
                         ...
                         >
                              ...
                              >
                                   ...
                                   >
                                        <a href="#" class="w-full px-6 py-2 mr-0 text-gray-700 md:px-0 lg:pl-2 md:mr-4 lg:mr-5 md:w-auto"
                                             >Sign In</a
                                        >
                                        <a
                                             href="#_"
